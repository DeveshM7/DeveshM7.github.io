      ...
      <div className="mx-auto max-w-3xl text-center">
        <Reveal>
          ...
          <p className="mx-auto mt-4 max-w-xl text-pretty leading-relaxed text-[#aeb6c2]">
            Interested in AI, embedded systems, hardware, or research collaboration?
        ...
        <Reveal delay={0.1}>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-5 py-2.5 text-sm font-medium text-[#f5f7fa] transition-all hover:-translate-y-0.5 hover:border-[#7dd3fc]/50 hover:shadow-[0_0_20px_rgba(125,211,252,0.15)]"
            >
        ...
        <div className="mt-16 border-t border-white/10 pt-8">
          <p className="font-mono text-xs text-[#aeb6c2]/60">
            © {new Date().getFullYear()} Devesh Maheshwari · Built with Next.js, Tailwind, and
            curiosity.
          </p>
        </div>
      </div>
