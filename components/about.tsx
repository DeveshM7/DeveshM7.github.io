...
export function About() {
  return (
    <section id="about" className="bg-[#f7f8fa] px-4 py-24 sm:px-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {quickFacts.map((fact, i) => (
              <Reveal key={fact.label} delay={i * 0.06}>
                <div className="h-full rounded-2xl border border-[#e5e7eb] bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#7dd3fc]/50 hover:shadow-md">
